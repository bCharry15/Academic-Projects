...
import co.edu.unicauca.piedraazul.agenda.pattern.builder.CitaResponseDesdeEntidadBuilder;
import co.edu.unicauca.piedraazul.agenda.pattern.builder.DirectorCitaResponse;
...
public class CitaRestController {
    ...
    private CitaResponse convertirACitaResponse(Cita cita) {
        ...
        CitaResponseDesdeEntidadBuilder builder = new CitaResponseDesdeEntidadBuilder(cita);
        return director.construir(builder);
    }
